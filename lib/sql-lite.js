...
const users = [
    { id: null, name: 'Test Doe', email: 'test@testing.com', password: 'rSnsw8mD5YEb', image: 'test_profile_picture.jpeg', created: (new Date()).toISOString(), update: null, deleted: null },
    { id: null, name: 'Jhoe Doe', email: 'jhoedoe@gmail.com', password: 'rSnsw8mD5YEb', image: 'test_profile_picture.jpeg', created: (new Date()).toISOString(), update: null, deleted: null },
    { id: null, name: 'Marie Doe', email: 'mariedoe@gmail.com', password: 'rSnsw8mD5YEb', image: 'test_profile_picture.jpeg', created: (new Date()).toISOString(), update: null, deleted: null },
];
